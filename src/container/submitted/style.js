...
const SubmitSorting = Styled.div`
    margin-bottom: 25px;
    .submit-sort-bar{
        display: flex;
        flex-wrap: wrap;
    ...
    @media (min-width: 1201px) and (max-width: 1300px) {
        ...
        .submit-sort-group .sort-group .layout-style a{
            width: 35px;
            height: 35px;
        }
        .submit-sort-group .sort-group .ant-select {
            min-width: 170px;
...
const SubmitPagination = Styled.div`
    .ant-pagination{
        display: flex;
        justify-content: flex-end;
...
const SubmitListTitle = Styled.div`
    h1{
        font-size: 15px;
        font-weight: 500;
        margin-bottom: 5px;
...
const SubmitListAssignees = Styled.div`
    ul{
        margin: -3px;
        padding: 0;
        display: flex;
...
const SubmitDetailsWrapper = Styled.div`
    .submit-header{
        display: flex;
        align-items: center;
